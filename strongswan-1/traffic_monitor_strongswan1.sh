...
aws cloudwatch put-metric-data --region ap-southeast-1 --metric-name VPN1_RX_Packets --namespace "VPN Traffic Statistics" --value $RX_packets
aws cloudwatch put-metric-data --region ap-southeast-1 --metric-name VPN1_RX_Bytes --namespace "VPN Traffic Statistics" --value $RX_bytes
aws cloudwatch put-metric-data --region ap-southeast-1 --metric-name VPN1_TX_Packets --namespace "VPN Traffic Statistics" --value $TX_packets
aws cloudwatch put-metric-data --region ap-southeast-1 --metric-name VPN1_TX_Bytes --namespace "VPN Traffic Statistics" --value $TX_bytes
sleep 30
done
